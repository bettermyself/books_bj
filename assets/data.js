...
function seedIfEmpty() {
  ...
  addChapter(b.id, {
    title: '在哈佛学校毕业典礼上的演讲',
    order: 1,
    content: `芒格以"反讽"方式列出保证痛苦人生的药方，核心是逆向思维：
...
【芒格的四味反讽药】
1. 反复无常——养成这个习惯，足以抵消所有优点
2. 拒绝借鉴他人经验——只从自身经验学习，保证二流成就
3. 失败后意志消沉——遭遇失败就一蹶不振
4. 忽视逆向思维——不去想"我将永远不去那个会死的地方"

【核心洞见】
"反过来想，总是反过来想。" —— 卡尔·雅可比

达尔文的工作方式：致力于寻求证据来否定已有理论，保持极端客观态度。
爱因斯坦的成功来自：好奇、专注、毅力和自省。

【2006年后记】
可靠是至关重要的。麦当劳是最值得尊敬的机构之一——它教会数百万少年承担工作责任、做可靠的人。`,
  });
}
